...
CURRENCY['ALL'] = Currency(code='ALL', numeric='008', decimals=2, symbol=u'', name=u'Lek', countries=[u'ALBANIA'])
CURRENCY['AMD'] = Currency(code='AMD', numeric='051', decimals=2, symbol=u'', name=u'Armenian Dram', countries=[u'ARMENIA'])
CURRENCY['ANG'] = Currency(code='ANG', numeric='532', decimals=2, symbol=u'', name=u'Netherlands Antillean Guilder', countries=[u'CURA\xc7AO', u'SINT MAARTEN (DUTCH PART)'])
...
CURRENCY['AWG'] = Currency(code='AWG', numeric='533', decimals=2, symbol=u'', name=u'Aruban Florin', countries=[u'ARUBA'])
CURRENCY['AZN'] = Currency(code='AZN', numeric='944', decimals=2, symbol=u'', name=u'Azerbaijanian Manat', countries=[u'AZERBAIJAN'])
CURRENCY['BAM'] = Currency(code='BAM', numeric='977', decimals=2, symbol=u'', name=u'Convertible Mark', countries=[u'BOSNIA AND HERZEGOVINA'])
...
CURRENCY['BGN'] = Currency(code='BGN', numeric='975', decimals=2, symbol=u'', name=u'Bulgarian Lev', countries=[u'BULGARIA'])
...
CURRENCY['BOB'] = Currency(code='BOB', numeric='068', decimals=2, symbol=u'', name=u'Boliviano', countries=[u'BOLIVIA, PLURINATIONAL STATE OF'])
...
CURRENCY['CZK'] = Currency(code='CZK', numeric='203', decimals=2, symbol=u'', name=u'Czech Koruna', countries=[u'CZECH REPUBLIC'])
CURRENCY['DJF'] = Currency(code='DJF', numeric='262', decimals=0, symbol=u'', name=u'Djibouti Franc', countries=[u'DJIBOUTI'])
CURRENCY['DKK'] = Currency(code='DKK', numeric='208', decimals=2, symbol=u'', name=u'Danish Krone', countries=[u'DENMARK', u'FAROE ISLANDS', u'GREENLAND'])
CURRENCY['DOP'] = Currency(code='DOP', numeric='214', decimals=2, symbol=u'', name=u'Dominican Peso', countries=[u'DOMINICAN REPUBLIC'])
...
CURRENCY['GTQ'] = Currency(code='GTQ', numeric='320', decimals=2, symbol=u'', name=u'Quetzal', countries=[u'GUATEMALA'])
...
CURRENCY['HNL'] = Currency(code='HNL', numeric='340', decimals=2, symbol=u'', name=u'Lempira', countries=[u'HONDURAS'])
CURRENCY['HRK'] = Currency(code='HRK', numeric='191', decimals=2, symbol=u'', name=u'Croatian Kuna', countries=[u'CROATIA'])
CURRENCY['HTG'] = Currency(code='HTG', numeric='332', decimals=2, symbol=u'', name=u'Gourde', countries=[u'HAITI'])
CURRENCY['HUF'] = Currency(code='HUF', numeric='348', decimals=2, symbol=u'', name=u'Forint', countries=[u'HUNGARY'])
CURRENCY['IDR'] = Currency(code='IDR', numeric='360', decimals=2, symbol=u'', name=u'Rupiah', countries=[u'INDONESIA'])
...
CURRENCY['ISK'] = Currency(code='ISK', numeric='352', decimals=0, symbol=u'', name=u'Iceland Krona', countries=[u'ICELAND'])
CURRENCY['JMD'] = Currency(code='JMD', numeric='388', decimals=2, symbol=u'', name=u'Jamaican Dollar', countries=[u'JAMAICA'])
...
CURRENCY['KGS'] = Currency(code='KGS', numeric='417', decimals=2, symbol=u'', name=u'Som', countries=[u'KYRGYZSTAN'])
...
CURRENCY['KZT'] = Currency(code='KZT', numeric='398', decimals=2, symbol=u'', name=u'Tenge', countries=[u'KAZAKHSTAN'])
...
CURRENCY['LTL'] = Currency(code='LTL', numeric='440', decimals=2, symbol=u'', name=u'Lithuanian Litas', countries=[u'LITHUANIA'])
CURRENCY['LVL'] = Currency(code='LVL', numeric='428', decimals=2, symbol=u'', name=u'Latvian Lats', countries=[u'LATVIA'])
...
CURRENCY['MKD'] = Currency(code='MKD', numeric='807', decimals=2, symbol=u'', name=u'Denar', countries=[u'MACEDONIA, THE FORMER YUGOSLAV REPUBLIC OF'])
...
CURRENCY['MYR'] = Currency(code='MYR', numeric='458', decimals=2, symbol=u'', name=u'Malaysian Ringgit', countries=[u'MALAYSIA'])
CURRENCY['MZN'] = Currency(code='MZN', numeric='943', decimals=2, symbol=u'', name=u'Mozambique Metical', countries=[u'MOZAMBIQUE'])
...
CURRENCY['NIO'] = Currency(code='NIO', numeric='558', decimals=2, symbol=u'', name=u'Cordoba Oro', countries=[u'NICARAGUA'])
CURRENCY['NOK'] = Currency(code='NOK', numeric='578', decimals=2, symbol=u'', name=u'Norwegian Krone', countries=[u'BOUVET ISLAND', u'NORWAY', u'SVALBARD AND JAN MAYEN'])
...
CURRENCY['PAB'] = Currency(code='PAB', numeric='590', decimals=2, symbol=u'', name=u'Balboa', countries=[u'PANAMA'])
CURRENCY['PEN'] = Currency(code='PEN', numeric='604', decimals=2, symbol=u'', name=u'Nuevo Sol', countries=[u'PERU'])
...
CURRENCY['PLN'] = Currency(code='PLN', numeric='985', decimals=2, symbol=u'', name=u'Zloty', countries=[u'POLAND'])
CURRENCY['PYG'] = Currency(code='PYG', numeric='600', decimals=0, symbol=u'', name=u'Guarani', countries=[u'PARAGUAY'])
CURRENCY['QAR'] = Currency(code='QAR', numeric='634', decimals=2, symbol=u'', name=u'Qatari Rial', countries=[u'QATAR'])
CURRENCY['RON'] = Currency(code='RON', numeric='946', decimals=2, symbol=u'', name=u'New Romanian Leu', countries=[u'ROMANIA'])
CURRENCY['RSD'] = Currency(code='RSD', numeric='941', decimals=2, symbol=u'', name=u'Serbian Dinar', countries=[u'SERBIA '])
...
CURRENCY['SEK'] = Currency(code='SEK', numeric='752', decimals=2, symbol=u'', name=u'Swedish Krona', countries=[u'SWEDEN'])
...
CURRENCY['SOS'] = Currency(code='SOS', numeric='706', decimals=2, symbol=u'', name=u'Somali Shilling', countries=[u'SOMALIA'])
...
CURRENCY['TRY'] = Currency(code='TRY', numeric='949', decimals=2, symbol=u'', name=u'Turkish Lira', countries=[u'TURKEY'])
CURRENCY['TTD'] = Currency(code='TTD', numeric='780', decimals=2, symbol=u'', name=u'Trinidad and Tobago Dollar', countries=[u'TRINIDAD AND TOBAGO'])
...
CURRENCY['UYU'] = Currency(code='UYU', numeric='858', decimals=2, symbol=u'', name=u'Peso Uruguayo', countries=[u'URUGUAY'])
CURRENCY['UZS'] = Currency(code='UZS', numeric='860', decimals=2, symbol=u'', name=u'Uzbekistan Sum', countries=[u'UZBEKISTAN'])
CURRENCY['VEF'] = Currency(code='VEF', numeric='937', decimals=2, symbol=u'', name=u'Bolivar Fuerte', countries=[u'VENEZUELA, BOLIVARIAN REPUBLIC OF'])
